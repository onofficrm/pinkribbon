...
if (!function_exists('onoff_builder_inject_site_profile')) {
    ...
    function onoff_builder_inject_site_profile($html, $id, $overrides = array())
    {
        ...
        $head = "\n"
            ...
            . '<link rel="icon" href="' . $escape(($site_url !== '' ? $site_url : '') . '/favicon.ico?v=20260729') . '" sizes="any">' . "\n"
            . '<link rel="icon" type="image/png" sizes="32x32" href="' . $escape(($site_url !== '' ? $site_url : '') . '/img/favicon-32x32.png?v=20260729') . '">' . "\n"
            . '<link rel="icon" type="image/png" sizes="192x192" href="' . $escape(($site_url !== '' ? $site_url : '') . '/img/favicon-192x192.png?v=20260729') . '">' . "\n"
            . '<link rel="apple-touch-icon" href="' . $escape(($site_url !== '' ? $site_url : '') . '/img/apple-touch-icon.png?v=20260729') . '">' . "\n"
